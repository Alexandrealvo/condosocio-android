...
$$(document).on('pageInit', function (e) {
                                                           ...
                                                           $.ajax({      //Função AJAX
                                                                  ...
                                                                  $('#calendar').fullCalendar({
                                                                                              ...
                                                                                              element.click(function() {
                                                                                                            ...
                                                                                                            '<p style="color: #000;font-size:16px;text-align:left;margin-left:10px"><strong>Data: </strong><span>'+( moment(event.start).format('lll'))+' até '+( moment(event.end).format('LT'))+'</p>'+
                ...
                $(document).ready(function(){
                                  ...
                                  $('#formace').submit(function(){
                                                       ...
                                                       $.ajax({      //Função AJAX
                                                              url:"https://www.condosocio.com.br/xdk/acesso.php",     //Arquivo php
                                                              type:"post",        //Método de envio
                                                              data: "tipopessoa="+tipopessoa+"&pessoa="+pessoa+"&cel="+cel+"&placa="+placa+"&marca="+marca+"&tipodoc="+tipodoc+"&documento="+documento+'&idfav='+idfav,
                                                              success: function (result){
                                                              ...
                                                              myApp.alert('Seu acesso foi enviado com sucesso à portaria!',nome, function () {
                                                                          
                                                                          //document.getElementById("acessos_visual").click();
                ...
                $(document).ready(function(){
                                  ...
                                  $.ajax({      //Função AJAX
                                         ...
                                         $('#favoritos').html('<option value="0">Selecione</option>'+buscafav);
                ...
                $(document).ready(function(){
                                  ...
                                  $('#favoritos').on('change', function() {
                                                     ...
                                                     $.ajax({      //Função AJAX
                                                            ...
                                                            $('#excluirfav').html('<a href="#" style="color:red;margin-left:70%;" class="apagarfav"  data-idfav ='+data.idfav+' data-confirm="Deseja apagar favorito?" data-confirm-title="Apagar?" data-close-on-cancel="true">Excluir Favorito</a>');
                ...
                $(document).ready(function(){
                                  $('#eventos').submit(function(){
                                                       ...
                                                       if (horafinal==""){
                                                       $('#hfvazio').html("campo obrigatório!");
                                                       return false;
                                                       }
                                                       ...
                                                       myApp.confirm('Confirma o envio do evento?',nome, function () {
                                                                     ...
                                                                     $.ajax({      //Função AJAX
                                                                            url:"https://www.condosocio.com.br/xdk/eventoadd.php",     //Arquivo php
                                                                            type:"post",        //Método de envio
                                                                            data: "titulo="+titulo+"&area="+area+"&dtinic="+dtinic+"&horainic="+horainic+"&horafinal="+horafinal+"&descricao="+descricao, //Dados
...
/*################ SELECT DE VISITANTES ################*/
                ...
                $(document).ready(function(){
                                  ...
                                  $.get('https:condosocio.com.br/xdk/banners_publi.php?espaco=Documentos',function(data){
                                        ...
                                        $('#banner_doc').html('<a href="'+data.url+'" class="external"><img src="https://condosocio.com.br/images/bannereventos/'+data.img+'" /></a>');
                                        })
                                  }
                                  Doc_Contagem();
                                  });
