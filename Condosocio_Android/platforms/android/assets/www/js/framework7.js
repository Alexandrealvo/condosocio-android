...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.prompt = function (text, title, cel, callbackOk, callbackCancel) {
            if (typeof title === 'function') {
                cel = cel;
                callbackCancel = arguments[2];
                callbackOk = arguments[1];
            ...
            return app.modal({
                text: text || '',
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                afterText: '<input type="tel" maxlength="2" class="modal-text-input">',
                buttons: [
                    {
                ...
                onClick: function (modal, index) {
                    ...
                    if (index === 1 && callbackOk) callbackOk( $(modal).find('.modal-text-input').val() + cel  );
                }
            });
        };
        ...
        app.modalPassword = function (text, title, callbackOk, callbackCancel) {
            ...
            return app.modal({
                text: text || '',
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                afterText: '<input type="text" name="modal-password" placeholder="(XX) XXXXX-XXXX"  onkeyup="mascara( this, mtel );" maxlength="15"  class="modal-text-input">',
                buttons: [
                    {
                        text: app.params.modalButtonCancel
                    },
        ...
        app.showIndicator = function () {
            $('body').append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><span class="preload preloader-black"></span></div>');
        };
        ...
        ************   Smart Select   ************
        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
            ...
            if (useSearchbar) {
                ...
                searchbarCancel = smartSelect.data('searchbar-cancel') || 'Cancelar';
            }
        ...
        ************   Handle clicks and make them fast (on tap);   ************
        ...
        app.initClickEvents = function () {
            ...
            function handleClicks(e) {
                ...
                // Swipeout Delete
                if (clicked.hasClass('apagaroco')) {
					
                    if (clickedData.confirm) {
						
                        var text = clickedData.confirm;
                        var title = clickedData.confirmTitle;
						var id = clickedData.id;
                        if (title) {
                            ...
                            app.confirm(text, title, function () {
								 ...
								 $.ajax({      //Função AJAX
                                    url:"https://www.condosocio.com.br/xdk/excluiroco.php?id="+id,

                                      success: function(data) {
										   if (data==1){
									 app.swipeoutDelete(clicked.parents('.swipeout'));	   
										myApp.alert('Ocorrência Deletada com Sucesso!','CondoSócio');
		                                        
										   }else{
										  myApp.alert('Houve Algum Problema! Registro Não Deletado','CondoSócio');
															  }
									                       }
								       })
 ...
 // Swipeout Delete
                if (clicked.hasClass('apagaraut')) {
                    
                    if (clickedData.confirm) {
                        
                        var text = clickedData.confirm;
                        var title = clickedData.confirmTitle;
                        var idaut = clickedData.idaut;
                        if (title) {
                            ...
                            app.confirm(text, title, function () {
                                 ...
                                 $.ajax({      //Função AJAX
                                    url:"https://www.condosocio.com.br/xdk/excluiraut.php?idaut="+idaut,

                                      success: function(data) {
                                           if (data==1){
                                     app.swipeoutDelete(clicked.parents('.swipeout'));     
                                        //myApp.alert('Autorização Deletada com Sucesso!','CondoSócio');
                                                
                                           }else{
                                          myApp.alert('Houve Algum Problema! Autorização Não Deletada','CondoSócio');
                                                              }
                                                           }
                                       })
...
// Swipeout Delete
                if (clicked.hasClass('apagaracesso')) {
                    
                    if (clickedData.confirm) {
                        
                        var text = clickedData.confirm;
                        var title = clickedData.confirmTitle;
                         var idace = clickedData.idace;
                        if (title) {
                            ...
                            app.confirm(text, title, function () {
                                 ...
                                 $.ajax({      //Função AJAX
                                    url:"https://www.condosocio.com.br/xdk/excluirace.php?idace="+idace,

                                      success: function(data) {
                                           if (data==1){
                                     app.swipeoutDelete(clicked.parents('.swipeout'));     
                                        //myApp.alert('Acesso deletado com sucesso!','CondoSócio');
                                                
                                           }else{
                                          myApp.alert('Houve Algum Problema! Acesso Não Deletado','CondoSócio');
                                                              }
                                                           }
                                       })
                    ...
                    if (clickedData.confirm) {
                        ...
                        if (title) {
                            ...
                            app.confirm(text, title, function () {
                                 ...
                                 $.ajax({      //Função AJAX
                                    url:"https://www.condosocio.com.br/xdk/excluirmsg.php?id="+id,

                                      success: function(data) {
                                           if (data==1){
                                     app.swipeoutDelete(clicked.parents('.swipeout'));     
                                        //myApp.alert('Mensagem Deletada com Sucesso!','CondoSócio');
                                                
                                           }else{
                                          myApp.alert('Houve Algum Problema! Mensagem Não Deletada','CondoSócio');
                                                              }
                                                           }
                                       })
                    ...
                    if (clickedData.confirm) {
                        ...
                        if (title) {
                            ...
                            app.confirm(text, title, function () {
                                 ...
                                 $.ajax({      //Função AJAX
                                    url:"https://www.condosocio.com.br/xdk/excluirdep.php?id="+id,

                                      success: function(data) {
                                           if (data==1){
                                     app.swipeoutDelete(clicked.parents('.swipeout'));     
                                        //myApp.alert('Dependente Deletado(a) com Sucesso!','CondoSócio');
                                                
                                           }else{
                                          myApp.alert('Houve Algum Problema! Dependente(a) não Deletado(a)','CondoSócio');
                                                              }
                                                           }
                                       })
...
if (clicked.hasClass('respostas')) {
       ...
       var id = clickedData.id;
        ...
        url:"https://www.condosocio.com.br/xdk/respocovis.php?id="+id,
        ...
        if (data[0].imgraiz==""){
            ...
            img_perfil_raiz='<div class="comm_avatar" "><img src="images/icons/black/user.png" alt="" title="" border="1" class="imgperfil" width="45" height="45"/></div>';
        } else {
           img_perfil_raiz = '<div class="comm_avatar" "><img src="http://condosocio.com.br/acond/downloads/fotosperfil/'+data[0].imgraiz+'" alt="" title="" border="1" class="imgperfil" width="45" height="45"/></div>';
            }
            
          descricao='<li class="comment_row">'+img_perfil_raiz+
                          
                           '<div class="comm_content"><label style="float: right"><i style="font-size:10px">'+data[0].dataraiz+' '+data[0].horaraiz+'h</i><p style="color:red">'+data[0].tipo+'</p></label><a href="#">'+data[0].nomeraiz+' '+data[0].sobreraiz+'</a><br>'+data[0].desc+'</div>'+
                           '</li>';
            for (i = 1; i < data.length; i++){
        

        if (data[i].imgperfil==""){
            img_perfil='<div class="comm_avatar" "><img src="images/icons/black/user.png" alt="" title="" border="1" class="imgperfil" width="40" height="40"/></div>';
        } else {
           img_perfil = '<div class="comm_avatar" "><img src="http://condosocio.com.br/acond/downloads/fotosperfil/'+data[i].imgperfil+'" alt="" title="" border="1" class="imgperfil" width="40" height="40"/></div>';
            }
                  if (data[i].idusu==data[0].idraiz){         
                 resp+='<li class="comment_row">'+img_perfil+
                                    
                                    '<div class="comm_content"><label style="float: right"><i style="font-size:10px">'+data[i].data+' '+data[i].hora+'h</i></label><a href="#">'+data[i].nomeusu+' '+data[i].sobrenomeusu+'</a><p>'+data[i].texto+' </p></div>'+
    
                               '</li>';
                           } else {
                 resp+='<li class="comment_row2" style="background-color:#d6fff4;">'+img_perfil+
                                   
                                    '<div class="comm_content2"><label><i style="font-size:10px">'+data[i].data+' '+data[i].hora+'h</i></label><a href="#" style="float:right;position:relative;padding-right:8px">'+data[i].nomeusu+' '+data[i].sobrenomeusu+'</a><p style="float:right;position:relative;padding-right:8px">'+data[i].texto+' </p></div>'+
            ...
            $('#varidoco').html('<input type="hidden" name="idoco" id="idoco" value=" '+id+' " />');
            $('#textrespoco').html(descricao+resp);
...
if (clicked.hasClass('respostasmsg')) {
       ...
       var id = clickedData.id;
        ...
        url:"https://www.condosocio.com.br/xdk/respmsgvis.php?id="+id,
        contentType: 'application/json',
        dataType: 'json',
        success: function(data) {
         ...
         myApp.hidePreloader();
          ...
          desc='<li class="comment_row">'+
                           '<div  class="comm_avatar">'+
                           '<img src="http://condosocio.com.br/acond/downloads/fotosperfil/'+data[0].imgraiz+'" alt="" title="" border="1" class="imgperfil" width="45" height="45"/></div>'+ 
                           '<div class="comm_content">'+
                           '<label style="float: right"><i style="font-size:14px">'+data[0].dataraiz+' '+data[0].horaraiz+'h</i></label>'+
                           '<a href="#"><label style="font-size:18px;font-weight: bold;">'+data[0].nomeraiz+' '+data[0].sobreraiz+'</label></a></div>'+
                           '<div class="comm_content">'+
                           '<br><label style="font-size:18px;">'+data[0].mensagem+'</label></div>'+
                           '</li>';
            for (i = 1; i < data.length; i++){

                  if (data[i].idusu==data[0].idraiz){         
                 respmsg+='<li class="comment_row">'+
                                    '<div class="comm_avatar"><img src="http://condosocio.com.br/acond/downloads/fotosperfil/'+data[i].imgperfil+'" alt="" title="" border="1" class="imgperfil" width="45" height="45"/></div>'+ 
                                    '<div class="comm_content">'+
                                    '<label style="float: right"><i style="font-size:14px">'+data[i].data+' '+data[i].hora+'h</i></label>'+
                                    '<a href="#"><label style="font-size:18px;font-weight: bold;">'+data[i].nomeusu+' '+data[i].sobrenomeusu+'</label></a></div>'+
                                    '<div class="comm_content">'+
                                   '<br><label style="font-size:18px;">'+data[i].texto+' </label>'+
                                    '</div>'+
    
                               '</li>';
                           } else {
                 respmsg+='<li class="comment_row2" style="background-color:#d6fff4;">'+
                                    '<div class="comm_avatar2">'+
                                        '<img src="http://condosocio.com.br/acond/downloads/fotosperfil/'+data[i].imgperfil+'" alt="" title="" border="1" class="imgperfil" width="45" height="45"/></div>'+ 
                              '<div class="comm_content2">'+
                                    '<label><i style="font-size:14px">'+data[i].data+' '+data[i].hora+'h</i></label>'+
                                    '<a href="#" style="float:right;position:relative;padding-right:8px">'+
                                       '<label style="font-size:18px;font-weight: bold;">'+data[i].nomeusu+' '+data[i].sobrenomeusu+'</label>'+
                                    '</a></div>'+
                                    '<div class="comm_content2">'+
                                    '<p style="font-size:18px;float:right;position:relative;padding-right:8px">'+data[i].texto+' </p>'+
                              '</div>'+
            ...
            $('#varidmsg').html('<input type="hidden" name="idmsg" id="idmsg" value=" '+id+' " />');
            $('#textrespmsg').html(desc+respmsg);
...
if (clicked.hasClass('docver')) {
    var nome= localStorage.getItem('nome');
    var pasta = clickedData.pasta;

     myApp.showIndicator();

        $.ajax({  
        url:"https://www.condosocio.com.br/xdk/documentos.php?pasta="+pasta,
        contentType: 'application/json',
        dataType: 'json',
        ...
        success: function(data) {
         ...
         myApp.hideIndicator();
          ...
          $('#pasta_doc').html('<div class="navbar_page_center">'+pasta+'</div>')
         
           if (data==""){

               $('.doc_visual').html('<div style="padding-top:100px;max-width:100%" class="logo">'+
              '<h2 class="page_title" style="font-size:22;font-weight:bold;;background-color:yellow">'+nome+', a pasta '+pasta+' está vazia.</h2></div>');

           } else {

          var myList = myApp.virtualList('.doc_visual', {
                items: data,
...
if (clicked.hasClass('imagemaut')) {
     var imgaut = clickedData.imgaut;
     var myPhotoBrowserStandalone = myApp.photoBrowser({
    photos : [
        'https://www.condosocio.com.br/acond/downloads/autsaida/'+imgaut,
    ...
    myApp.addNotification({
        title: 'SEM IMAGEM!',
        message: 'Autorização não possui imagem',
        color: '#ffffff',
    })
...
if (clicked.hasClass('imagemoco')) {
     var imgoco = clickedData.imgoco;
     var myPhotoBrowserStandalone = myApp.photoBrowser({
    photos : [
        'https://www.condosocio.com.br/acond/downloads/ocorrencias/'+imgoco,
    ...
    myApp.addNotification({
        title: 'SEM IMAGEM!',
        message: 'Ocorrência não possui imagem',
        color: '#ffffff',
    })
...
if (clicked.hasClass('favorito')) {
   
    var idfav = clickedData.idfav;
    var fav =   clickedData.fav;
    var idace = clickedData.idace;
                   ...
                   $.ajax({  
                    ...
                    url:"https://www.condosocio.com.br/xdk/favmudar.php?idfav="+idfav+"&fav="+fav+"&idace="+idace,
                    //contentType: 'application/json',
                    //dataType: 'json',
                        success: function(data) {
                            myApp.hidePreloader();
                ...
                if (data==1){
                         ...
                         myApp.alert('Adicionado a Favoritos!','CondoSócio', function () {
                        app.swipeoutClose(clicked.parents('.swipeout')); 
                         $('#img_heart'+idace).attr("src", "images/icons/white/hearto.png");
                          $('#heart'+idace).attr('data-fav', 0); 
                         
                         })             

                }else {

                    myApp.alert('Retirado de Favoritos!','CondoSócio', function () {
                       app.swipeoutClose(clicked.parents('.swipeout')); 
                      $('#img_heart'+idace).attr("src", "images/icons/white/heart.png");
                      $('#heart'+idace).attr('data-fav', 1);  
...
if (clicked.hasClass('dep_editar')) {
       
       var idep = clickedData.idep;
...
$.ajax({  
          ...
          url:"https://www.condosocio.com.br/xdk/dep_editar.php?idep="+idep,
          contentType: 'application/json',
          dataType: 'json',
           success: function(data) {
          ...
          myApp.hideIndicator();
           ...
           if(data[0].img_perfil != '' && data[0].img_perfil != null){

              $(".foto_dep_perfil").html('<img src="https://www.condosocio.com.br/acond/downloads/fotosperfil/'+data[0].img_perfil+'" class="imgperfil" width="90" height="90">');

            } else {

              $(".foto_dep_perfil").html('<img src="images/semavatar.png" class="imgperfil" width="90" height="90"><div style="color:#1a35d8;font-size:15px"></div>');
            }

             $('#checkbox_status').html('<input id="21" class="switch switch--shadow" type="checkbox" value="0" onchange="mudar(this,'+idep+');"><label for="21"></label><label for="21"></label>'); 
          
        if (data[0].status!='Normal'){ 
           $('#21').attr("checked", true);
           $('#text_bloqueio').html('<label style="color:red">Suspenso:</label>');
        } 
      
  
            $('#dep_nome').html('<input type="text" name="nome" id="nome" placeholder="Entre com nome..." value="'+data[0].nome+'" class="form_input "/>');

            $('#dep_sobre').html('<input type="text" name="sobrenome" id="sobrenome" placeholder="Entre com sobrenome..." value="'+data[0].sobrenome+'" class="form_input "/><input class="" type="hidden" name="idep"  id="idep" value="'+data[0].id+'" />');


            $('#dep_email').html('<input type="text" name="email" id="email" placeholder="Entre com e-mail..." value="'+data[0].email+'" class="form_input "/>');

            $('#hidden').html('<input type="hidden" name="id_hidden" id="id_hidden" value="'+idep+'" />');

                    if(data[0].genero!=""){

                      $('#genero_dep').html('<option  id="genero_dep" value="'+data[0].genero+'">'+data[0].genero+'</option>');
                      $('#genero_dep').val(data[0].genero);
                    }
...
$.ajax({  
          ...
          url:"https://www.condosocio.com.br/xdk/excluirfav.php?idfav="+idfav,
          contentType: 'application/json',
          dataType: 'json',
        success: function(data) {
            myApp.hideIndicator();
if (data==1){
 ...
 myApp.alert('Favorito foi deletado com sucesso!','CondoSócio', function () {
                            window.history.back();                     
                                  });
 ...
 myApp.alert('Erro! Tente novamente.','CondoSócio', function () {
                           return false;
...
if (clicked.hasClass('apagar_dep')) {
       var idep = clickedData.idep; 
     
   myApp.confirm('Deseja deletar dependente?','<div style="color:red">Alerta!</div>', function () { 
   //myApp.showPreloader('Aguarde só um instante...') ;   
      
$.ajax({  

          url:"https://www.condosocio.com.br/xdk/excluir_dep.php?idep="+idep,
          contentType: 'application/json',
          dataType: 'json',
        success: function(data) {
           // myApp.hidePreloader();
...
if (data==1){
 ...
 //myApp.alert('Dependente foi deletado com sucesso!','CondoSócio', function () {
                 app.swipeoutDelete(clicked.parents('.swipeout'));
...
if (clicked.hasClass('editarlista')) {

var ideve= clickedData.ideve;
$.ajax({  

          url:"https://www.condosocio.com.br/xdk/listaconv.php?ideve="+ideve,
          type:"get", 
          contentType: 'application/json',
          dataType: 'json', 
  ...
  if (data.listaconv=="undefined" || data.listaconv==" "){
   $('#ideventos').val(ideve);   
   $(".tags").val(" ");
            } else{
            
   $('#ideventos').val(ideve);   
   $(".tags").val(data.listaconv);
...
if (clicked.hasClass('filtro_forn')) {

var idativ= clickedData.idativ;
                ...
                template: '<li class="item-content" style="margin-bottom:10px;margin-top:10px" >' +
                  '<a href="inforn.html"  data-idforn="{{id}}" class="ache item-link item-content">'+
                      ...
                      '<div class="item-inner" style="padding-bottom:5px">'+
                        ...
                        '<div class="item-text buscar" >{{atividades}}</div>'+
                      '</div>'+
                    '</a>'+
                  '</li>',
           });
...
if (clicked.hasClass('ache')) {
var idforn= clickedData.idforn;
$('#info').addClass("preload").show;  
$.ajax({  
       ...
       $('#info').removeClass("preload").hide;  
        ...
        $('#info').html('<div class="card">'+
              ...
              //$('#mapaforn').html('<iframe width="100%" height="200" frameborder="0" scrolling="no" marginheight="0" class="external" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=pt&amp;geocode=&amp;q='+data[0].end+'-'+data[0].bairro+'-'+data[0].cidade+'-'+data[0].uf+'&amp;aq=0&amp;ie=UTF8&amp;hq=&amp;hnear='+data[0].end+'-'+data[0].bairro+'-'+data[0].cidade+'-'+data[0].uf+'&amp;t=m&amp;ll='+data[0].lat+','+data[0].lng+'&amp;z=15&amp;iwloc=&amp;output=embed"></iframe>');
      ...
      // Sortable
        ...
        ************   Calendar   ************
        ...
        var Calendar = function (params) {
            var p = this;
            var defaults = {
                monthNames: ['Janeiro', 'February', 'March', 'April', 'May', 'June', 'July', 'August' , 'September' , 'Outubro', 'November', 'December'],
                monthNamesShort: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Out', 'Nov', 'Dez'],
